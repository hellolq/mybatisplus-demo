...
public class MPGenerator {
    ...
    //作者、包名、去除表前缀
    private static final String author = "h1n1";
    private static final String package_name = "com.example.demo";
    private static final String TABLE_PREFIX = "sys_";

    //数据库
    private static final String url = "jdbc:mysql://localhost:3306/ms?useUnicode=true&characterEncoding=utf8&useSSL=true&serverTimezone=UTC";
